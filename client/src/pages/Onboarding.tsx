            ...
            <div className="space-y-6 onboarding-wrapper">
              ...
              <div className="space-y-8 max-w-lg">
                ...
                <div className="space-y-6">
                  ...
                  <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v)=> updateField('dailyCalorieBurn',v)} unit="kcal" infoText="the total calories you aim to burn through excerise and activity each day."/>
